    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 pb-16 px-4 sm:px-6 lg:px-8 flex items-center justify-center transition-colors duration-300">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Projeto não encontrado</h2>
          <Link
            to="/projects"
            className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium"
          >
            <ArrowLeft className="mr-2 h-5 w-5" /> Voltar para Projetos
          </Link>
        </div>
      </div>
    );
...
✔ Desenvolvimento de estratégias para melhorar a retenção. <br />
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Ferramentas utilizadas</h2>
