      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
            Uma coleção de projetos de análise de dados e visualização que demonstram minhas habilidades e experiência em transformar dados em insights acionáveis.
          </p>
        </div>
