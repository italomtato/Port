        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">What You'll Learn</h2>
              <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 mb-6">
                <li className="mb-2">Understanding the core concepts and techniques</li>
                <li className="mb-2">Practical implementation with real-world examples</li>
                <li className="mb-2">Best practices and common pitfalls to avoid</li>
                <li className="mb-2">Advanced strategies for optimization</li>
              </ul>
              
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Related Videos</h2>
